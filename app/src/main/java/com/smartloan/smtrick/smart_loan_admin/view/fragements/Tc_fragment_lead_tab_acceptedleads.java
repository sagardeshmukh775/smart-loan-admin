...
public class Tc_fragment_lead_tab_acceptedleads extends Fragment {
    ...
    /* renamed from: com.smartloan.smtrick.smart_loan_admin.view.fragements.Tc_fragment_lead_tab_acceptedleads$1 */
    ...
    private void getteLeed() {
        ...
        this.leedRepository.readLeedsByStatus(Constant.STATUS_APPROVED, new C09511());
    }
