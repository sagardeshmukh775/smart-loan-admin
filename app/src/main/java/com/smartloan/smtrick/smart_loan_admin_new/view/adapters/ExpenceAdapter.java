...
public class ExpenceAdapter extends RecyclerView.Adapter<ExpenceAdapter.ViewHolder> {
    ...
    public ExpenceAdapter(Context context, List<Expences> userArrayList, boolean isFromRequest) {
    ...
    @Override
    public ExpenceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.generated_bill_layout, parent, false);
        ExpenceAdapter.ViewHolder viewHolder = new ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final ExpenceAdapter.ViewHolder holder, int position) {
