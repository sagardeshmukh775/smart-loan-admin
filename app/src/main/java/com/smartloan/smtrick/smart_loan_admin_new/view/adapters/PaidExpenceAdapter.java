...
public class PaidExpenceAdapter extends RecyclerView.Adapter<PaidExpenceAdapter.ViewHolder> {
    ...
    public PaidExpenceAdapter(Context context, List<Expences> userArrayList, boolean isFromRequest) {
    ...
    @Override
    public PaidExpenceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.paid_bill_layout, parent, false);
        PaidExpenceAdapter.ViewHolder viewHolder = new ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final PaidExpenceAdapter.ViewHolder holder, int position) {
