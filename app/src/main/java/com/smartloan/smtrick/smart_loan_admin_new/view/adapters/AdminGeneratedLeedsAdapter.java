...
public class AdminGeneratedLeedsAdapter extends RecyclerView.Adapter<TelecallerLeedsViewHolder> {
    ...
    public AdminGeneratedLeedsAdapter(){}

    public AdminGeneratedLeedsAdapter(Context context, ArrayList<LeedsModel> data) {
