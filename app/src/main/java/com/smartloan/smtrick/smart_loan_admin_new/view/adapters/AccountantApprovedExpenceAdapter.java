...
public class AccountantApprovedExpenceAdapter extends RecyclerView.Adapter<AccountantApprovedExpenceAdapter.ViewHolder> {
    ...
    public AccountantApprovedExpenceAdapter(Context context, List<Expences> userArrayList, boolean isFromRequest) {
    ...
    @Override
    public AccountantApprovedExpenceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.acct_approved_bill_layout, parent, false);
        AccountantApprovedExpenceAdapter.ViewHolder viewHolder = new ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final AccountantApprovedExpenceAdapter.ViewHolder holder, int position) {
