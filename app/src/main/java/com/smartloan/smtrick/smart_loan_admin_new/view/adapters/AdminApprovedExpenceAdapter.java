...
public class AdminApprovedExpenceAdapter extends RecyclerView.Adapter<AdminApprovedExpenceAdapter.ViewHolder> {
    ...
    public AdminApprovedExpenceAdapter(Context context, List<Expences> userArrayList, boolean isFromRequest) {
    ...
    @Override
    public AdminApprovedExpenceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.admin_approved_bill_layout, parent, false);
        AdminApprovedExpenceAdapter.ViewHolder viewHolder = new ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final AdminApprovedExpenceAdapter.ViewHolder holder, int position) {
