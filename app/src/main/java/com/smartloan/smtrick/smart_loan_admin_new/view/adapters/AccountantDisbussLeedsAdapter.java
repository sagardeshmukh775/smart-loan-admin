...
public class AccountantDisbussLeedsAdapter extends RecyclerView.Adapter<AcctDisbussLeedsViewHolder> {
    ...
    public AccountantDisbussLeedsAdapter(){}

    public AccountantDisbussLeedsAdapter(Context context, ArrayList<LeedsModel> data) {
        this.leedModelArrayList = data;
        this.context = context;
    }

    @Override
    public AcctDisbussLeedsViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
        AccountantDisbussLeedsAdapterLayoutBinding telecallerLeedsAdapterLayoutBinding;
        telecallerLeedsAdapterLayoutBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.accountant_disbuss_leeds_adapter_layout, parent, false);
        return new AcctDisbussLeedsViewHolder(telecallerLeedsAdapterLayoutBinding);
    }
    ...
    @Override
    public void onBindViewHolder(final AcctDisbussLeedsViewHolder holder, final int listPosition) {
        try {
